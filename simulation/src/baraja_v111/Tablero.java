...
public class Tablero extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setName("Tablero "); // NOI18N

        jLabel1.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 0, 0));
        jLabel1.setText("Número de juegos:");

        txtNumJuegos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtNumJuegosActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        ...
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                ...
                                                .addGap(18, 18, 18)
                                                .addComponent(txtNumJuegos, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnSimulacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimulacionActionPerformed
        if (txtNumJuegos.getText().equals("")) {
            showMessageDialog(null, "Ingrese una cantidad.");
        } else {
            System.out.println(principal.reparteCartas());
        }
    }//GEN-LAST:event_btnSimulacionActionPerformed

    private void txtNumJuegosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtNumJuegosActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtNumJuegosActionPerformed
